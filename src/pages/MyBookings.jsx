...
export default function MyBookings() {
    ...
    useEffect(() => {
        ...
        if (user?.email) {
            axios.get("https://studynook-server-alpha.vercel.app/api/bookings", { withCredentials: true })
                .then((res) => {
    ...
    const handleCancelBooking = (bookingId) => {
        ...
        axios.patch(`https://studynook-server-alpha.vercel.app/api/bookings/${bookingId}/cancel`, {}, { withCredentials: true })
            .then(() => {
